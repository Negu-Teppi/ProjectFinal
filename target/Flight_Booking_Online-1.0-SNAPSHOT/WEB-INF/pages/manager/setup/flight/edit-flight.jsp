                        ...
                        <div class="card-box">
                            ...
                            <mvc:form action="${pageContext.request.contextPath}/manager/flight/result"
                                ...
                                <div class="card-body row">
                                    ...
                                    <c:if test="${action == 'update'}">
                                        <input class="mdl-textfield__input" type="text" value="${flight.id}" name="id" hidden/>
                                    </c:if>
                                            ...
                                            <select name="flightRoute.id" class="mdl-textfield__input">
                                                <c:forEach items="${flightRoutes}" var="flightRoute">
                                                    <c:if test="${flightRoute.destination.airportName == flight.flightRoute.destination.airportName
                                                        ...
                                                        <option value="${flightRoute.id}" selected><c:out value="${flightRoute.departure.airportName} to
                                                            ${flightRoute.destination.airportName}" /></option>
                                                    </c:if>
                                                    <c:if test="${flightRoute.destination.airportName != flight.flightRoute.destination.airportName
                                                                && flightRoute.departure.airportName != flight.flightRoute.departure.airportName}">
                                                        <option value="${flightRoute.id}" ><c:out value="${flightRoute.departure.airportName} to
                                                            ${flightRoute.destination.airportName}" /></option>
                                                    </c:if>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <select name="promotion.id" class="mdl-textfield__input">
                                                <c:forEach items="${promotions}" var="promotion">
                                                    <c:if test="${promotion.name == flight.promotions.name}">
                                                        <option value="${promotion.id}" selected>${promotions.name}</option>
                                                    </c:if>
                                                    <c:if test="${promotion.name != flight.promotions.name}">
                                                        <option value="${promotion.id}">${promotions.name}</option>
                                                    </c:if>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="mdl-textfield__input" type="date" value="${flight.depart}" name="depart">
                                            <label class="mdl-textfield__label">Depart</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input class="mdl-textfield__input" type="date" value="${flight.arrival}" name="arrival">
