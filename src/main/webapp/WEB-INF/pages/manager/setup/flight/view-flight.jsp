...
<%--                                            <th class="center"> Promotion </th>--%>
                                        ...
                                        <c:forEach items="${flights}" var="flight">
                                            <tbody>
                                            <tr class="odd gradeX">
                                                <td class="center">${flight.flightRoute.departure.airportName}</td>
                                                <td class="center">${flight.flightRoute.destination.airportName}</td>
                                                <td class="center">${flight.operation.name}</td>
<%--                                                <td class="center">${flight.promotions.name}</td>--%>
                                                <td class="center">
                                                    <fmt:formatDate type = "date" value = "${flight.depart}" />
                                                </td>
                                                <td class="center">
                                                    <fmt:formatDate type = "date" value = "${flight.arrival}" />
                                                </td>
